...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'game_game', 'duration',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'game_game', 'duration')
    ...
    models = {
        ...
        u'teams.team': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'932d87954bc54b60b05b00fae0448500'", 'max_length': '32'})
        }
    }
